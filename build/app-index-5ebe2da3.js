    ...
    ;
{
    ...
    if (((_b$2 = window.ShadyDOM) === null || _b$2 === void 0 ? void 0 : _b$2.inUse) && polyfillSupport$2 === undefined) {
...
const wrap = ((_b$1 = window.ShadyDOM) === null || _b$1 === void 0 ? void 0 : _b$1.inUse) &&
...
const createMarker = (v = '') => d$1.createComment(v);
...
const walker = d$1.createTreeWalker(d$1, 129 /* NodeFilter.SHOW_{ELEMENT|COMMENT} */, null, false);
...
class TemplateInstance {
    ...
    _clone(options) {
        ...
        const fragment = ((_a = options === null || options === void 0 ? void 0 : options.creationScope) !== null && _a !== void 0 ? _a : d$1).importNode(content, true);
            ...
            // temporarily cast to any because of a Type bug with the router
            {
                ...
                children: [
                    { path: '/', component: 'app-home' },
                    {
                        ...
                        component: 'app-about',
                        action: async () => {
                            await import('./app-about-8c97249c.js');
                        },
                    },
                ],
            },
...
//# sourceMappingURL=app-index-5ebe2da3.js.map
